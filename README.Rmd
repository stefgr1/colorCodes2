...
# unikn `r packageVersion('colorCodes')` <img src = "./inst/pix/unikn.png" align = "right" alt = "unikn::" width = "150px" />
...
This package is build on the original version from the University of Konstanz (**unikn** package) and adds the colors of the University of Tuebingen. This package is for internal use only and limited to the members of the University of Tuebingen. The following states the general information for the **unikn** package which also applies to this adjusted package called **colorCodes**. I added two palettes for the primary and secondary colors called "uni_tuebingen_1" and "uni_tuebingen_2". 
