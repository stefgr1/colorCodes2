...
#' Default: \code{col_title = uni_tuebingen_1[[3]]}. 
...
#' 
#' \donttest{
#'   # Plotting iris dataset (using ggplot2, theme_tueb_1, and colorCodes colors):
#'   
...
#' 
#' \code{theme_tueb_2} provides an alternative \bold{colorCodes} theme 
#' to use in \bold{ggplot2} commands. 
#' 
